    ...
    <ul class="navbar-nav ml-auto">
      ...
      {{-- <li class="nav-item">
        <a class="nav-link" data-widget="fullscreen" href="#" role="button">
          <i class="fas fa-logoff"></i>
        </a>
        <a class="nav-link text-danger btn btn-outline-success" href="{{ route('logout') }}"
      ...
      {{-- <a class="dropdown-item" href="{{ route('logout') }}"
                                    ...
                                    {{-- <span class="text-success pl-1 pr-2 pt-2">Hi, {{ Auth::user()->name }}</span> --}}

        {{-- <li class="nav-item">
            <a href="{{ route('logout') }}" class="nav-link btn btn-outline-danger" onclick="event.preventDefault();
            document.getElementById('logout-form').submit();">
                {{ __('Logout') }}
            </a>
        ...
        <li class="dropdown user user-menu ml-2 pt-2 text-white">
            <a href="#" class="dropdown-toggle text-white" data-toggle="dropdown" aria-expanded="false">
                <img src="{{ asset('default.jpg') }}" class="user-image"
                    alt="User Image">
            ...
            <ul class="dropdown-menu pt-4 bg-info mt-2">
                ...
                <li class="user-footer">
                    <div class="float-left">
                        ...
                        <a href="#" class="btn btn-outline-success btn-flat">User Profile</a>
                    </div>
